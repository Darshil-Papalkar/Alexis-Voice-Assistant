...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            web_series_folder = 'path\web_series_folder_path'   # web_series_path = "D:\Web Series"
            ...
            webbrowser.get().open_new_tab('https://www.linkedin.com/in/darshil-papalkar-923016194/')
            if cmd == 'None':
                speak('Going back to main program...Continuing')
                continue
            elif cmd == 'exit':
